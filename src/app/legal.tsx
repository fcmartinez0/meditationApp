  ...
  return (
    <Screen scroll>
      ...
      <Section title="Wellness, not medical advice">
        ...
        <P>
          The frequency tracks (binaural beats) and any associated benefits reflect popular wellness
          practice rather than established medical science; the evidence is mixed. Headphones are
          recommended for binaural tracks.
        </P>
        <P>
        ...
        <P>Protect your hearing — keep the volume at a comfortable level.</P>
      </Section>
