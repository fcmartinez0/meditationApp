...
export const SECTIONS: Section[] = [
  ...
  },
  {
    ...
    items: [
      { key: 'none', label: 'Silence', icon: 'volume-mute-outline', hint: 'No background sound' },
      { key: 'rain', label: 'Rain', icon: 'rainy-outline', hint: 'Steady rainfall' },
      { key: 'ocean', label: 'Ocean', icon: 'boat-outline', hint: 'Slow ocean swells' },
      { key: 'forest', label: 'Forest', icon: 'leaf-outline', hint: 'Soft wind & forest' },
      { key: 'stream', label: 'Stream', icon: 'water-outline', hint: 'Babbling brook' },
      { key: 'fire', label: 'Campfire', icon: 'flame-outline', hint: 'Warm crackling fire' },
      { key: 'night', label: 'Night', icon: 'star-outline', hint: 'Crickets under a quiet night' },
      ...
      { key: 'white', label: 'White Noise', icon: 'radio-outline', hint: 'Bright, even hush' },
